...
namespace SecurityClearanceWebApp.Controllers
{
    ...
    public class SecuritypassController : Controller
    {
        //get db connection
        ...
        string title = Resources.Passes.ResourceManager.GetString("SecurityPass" + "_" + "ar");
        ...
        private int ACCESS_TYPE_CODE = 2;
        private int COMPANY_TYPE_CODE = 2;
        public SecuritypassController()
        {
            ViewBag.Managepasses = "Managepasses";

            // don't edit ViewBag.controllerName 
            ViewBag.controllerName = "Securitypass";
            //set icon of the controller from fontawsome library 
            ViewBag.controllerIconClass = "fa fa-user-shield";
            if (Language.GetCurrentLang() == "en")
            {
                title = Resources.Passes.ResourceManager.GetString("SecurityPass" + "_" + "en");
            }
        ...
        public ActionResult Comments(int? id)
        {
            ...
            //check if record in the table RA42_SECURITY_PASS_DTL to get its commenst 
            RA42_SECURITY_PASS_DTL rA42_SECURITY_PASS_DTL = db.RA42_SECURITY_PASS_DTL.Find(id);
            if (rA42_SECURITY_PASS_DTL == null)
            {
                 return NotFound();
            }
            ...
            {
                if (rA42_SECURITY_PASS_DTL.SERVICE_NUMBER != currentUser && rA42_SECURITY_PASS_DTL.RESPONSIBLE !=currentUser)
                {
                    if (rA42_SECURITY_PASS_DTL.ISOPENED != true)
                    {
            ...
            else
            {
                ...
                {
                    if (ViewBag.RESPO_STATE != rA42_SECURITY_PASS_DTL.RA42_WORKFLOW_RESPONSIBLE_MST.WORKFLOWID)
                    {
                        if (ViewBag.ADMIN != true && ViewBag.DEVELOPER != true)
                        {
                            return NotFound();
            ...
            return View(rA42_SECURITY_PASS_DTL);
        }
        ...
        public ActionResult Comments(RA42_SECURITY_PASS_DTL rA42_SECURITY_PASS_DTL, string COMMENT)
        {
            ViewBag.activetab = "Comments";
            var general_data = db.RA42_SECURITY_PASS_DTL.Where(a => a.SECURITY_CODE == rA42_SECURITY_PASS_DTL.SECURITY_CODE).FirstOrDefault();
            ...
            if (COMMENT.Length > 0)
            {
                ...
                rA42_COMMENT.PASS_ROW_CODE = rA42_SECURITY_PASS_DTL.SECURITY_CODE;
            ...
            //get comments 
            var cOMMENTS = db.RA42_COMMENTS_MST.Where(a => a.PASS_ROW_CODE == rA42_SECURITY_PASS_DTL.SECURITY_CODE && a.DLT_STS != true && a.ACCESS_TYPE_CODE == ACCESS_TYPE_CODE).ToList();
            ViewBag.COMMENTS = cOMMENTS;
            return View(rA42_SECURITY_PASS_DTL);
        ...
        public JsonResult GetList()
        {
            ...
            var empList = db.RA42_SECURITY_PASS_DTL.Where(a => a.WORKFLOW_RESPO_CODE != null).Select(a => new
            {
                ...
                DATE_TO = a.DATE_TO,
                COMMENTS = a.RA42_ACCESS_TYPE_MST.RA42_COMMENTS_MST.Where(x => x.PASS_ROW_CODE == a.SECURITY_CODE).Count()
        ...
        public JsonResult GetListPrinted()
        {
            ...
            // empList = db.RA42_VECHILE_PASS_DTL.OrderByDescending(a => a.VECHILE_PASS_CODE).ToList<RA42_VECHILE_PASS_DTL>();
            var empList = db.RA42_SECURITY_PASS_DTL.Where(a => a.RA42_WORKFLOW_RESPONSIBLE_MST.WORKFLOWID == WORKFLOWID && a.STATION_CODE == STATION_CODE 
            && a.DLT_STS != true 
            ...
            if (!string.IsNullOrEmpty(searchValue))//filter
            {
                ...
                else
                {
                     empList = empList.
                Where(x => x.SERVICE_NUMBER.Contains(searchValue) || x.CIVIL_NUMBER.Contains(searchValue) 
                || x.NAME_A.Contains(searchValue) || x.GSM.Contains(searchValue)
                ).ToList();
                }
            }
            int totalrowsafterfiltering = empList.Count;
        ...
        public ActionResult Authopasses()
        {
            ...
            var rA42_SECURITY_PASS_DTL = db.RA42_SECURITY_PASS_DTL.Where(a => a.RA42_WORKFLOW_RESPONSIBLE_MST.SERVICE_NUMBER == currentUser 
            && a.DLT_STS != true && a.RA42_WORKFLOW_RESPONSIBLE_MST.DLT_STS != true 
            && a.RA42_WORKFLOW_RESPONSIBLE_MST.ACTIVE != false).OrderByDescending(a => a.SECURITY_CODE);
            return View(rA42_SECURITY_PASS_DTL.ToList());
        }
        //this view is for permits cell and security officer 
        public async Task<ActionResult> Newpasses()
        {
            ViewBag.activetab = "Newpasses";
            var rA42_SECURITY_PASS_DTL = await db.RA42_SECURITY_PASS_DTL.Where(a => a.RA42_WORKFLOW_RESPONSIBLE_MST.WORKFLOWID == WORKFLOWID 
            && a.STATION_CODE == STATION_CODE && a.DLT_STS != true  && a.STATUS !=true).OrderByDescending(a => a.SECURITY_CODE).ToListAsync();
            return View(rA42_SECURITY_PASS_DTL);
        }
        public async Task<ActionResult> ToPrint()
        {
            ...
            var rA42_SECURITY_PASS_DTL = await db.RA42_SECURITY_PASS_DTL.Where(a => a.RA42_WORKFLOW_RESPONSIBLE_MST.WORKFLOWID == WORKFLOWID
            && a.STATION_CODE == STATION_CODE && a.DLT_STS != true && a.ISPRINTED != true && a.STATUS == true).OrderByDescending(a => a.SECURITY_CODE).ToListAsync();
            return View(rA42_SECURITY_PASS_DTL);
        }
        ...
        public ActionResult Details(int? id)
        {
            ...
            //get zones and documents of the permit
        ...
        public ActionResult Card(int? id)
        {
            ...
            if (Language.GetCurrentLang() == "en")
            {
                var types = db.RA42_TRANSACTION_TYPE_MST.Where(a => a.DLT_STS != true && a.FORCE_ID == rA42_SECURITY_PASS_DTL.RA42_STATIONS_MST.FORCE_ID).Select(s => new { TRANSACTION_TYPE_CODE = s.TRANSACTION_TYPE_CODE, TRANSACTION_NAME = s.TRANSACTION_NAME_E + " - Amount: " + s.AMOUNT + " R.O" }).ToList();
                ViewBag.TRANSACTION_TYPE_CODE = new SelectList(types, "TRANSACTION_TYPE_CODE", "TRANSACTION_NAME");

            }
            else
            {
                var types = db.RA42_TRANSACTION_TYPE_MST.Where(a => a.DLT_STS != true && a.FORCE_ID == rA42_SECURITY_PASS_DTL.RA42_STATIONS_MST.FORCE_ID).Select(s => new { TRANSACTION_TYPE_CODE = s.TRANSACTION_TYPE_CODE, TRANSACTION_NAME = s.TRANSACTION_NAME_A + " - السعر: " + s.AMOUNT + " ريال" }).ToList();
        ...
        public ActionResult Card(string CheckPrinted, int TRANSACTION_TYPE_CODE, string TRANSACTION_REMARKS, 
            HttpPostedFileBase RECEIPT, RA42_SECURITY_PASS_DTL _SECURITY_PASS_DTL)
        {
            ViewBag.activetab = "card";

          
            //check if the record in the table 
            RA42_SECURITY_PASS_DTL rA42_SECURITY_PASS_DTL = db.RA42_SECURITY_PASS_DTL.Find(_SECURITY_PASS_DTL.SECURITY_CODE);
            if (rA42_SECURITY_PASS_DTL == null)
            {
                return NotFound();
            }
            ...
            ViewBag.GetZones = db.RA42_ZONE_MASTER_MST.Where(a => a.ACCESS_ROW_CODE == rA42_SECURITY_PASS_DTL.SECURITY_CODE && a.DLT_STS != true && a.ACCESS_TYPE_CODE == ACCESS_TYPE_CODE).ToList();
            ViewBag.GetFiles = db.RA42_FILES_MST.Where(a => a.ACCESS_ROW_CODE == rA42_SECURITY_PASS_DTL.SECURITY_CODE && a.DLT_STS != true && a.ACCESS_TYPE_CODE == ACCESS_TYPE_CODE).ToList();
            if (Language.GetCurrentLang() == "en")
            {
                var types = db.RA42_TRANSACTION_TYPE_MST.Where(a => a.DLT_STS != true && a.FORCE_ID == rA42_SECURITY_PASS_DTL.RA42_STATIONS_MST.FORCE_ID).Select(s => new { TRANSACTION_TYPE_CODE = s.TRANSACTION_TYPE_CODE, TRANSACTION_NAME = s.TRANSACTION_NAME_E + " - Amount: " + s.AMOUNT + " R.O" }).ToList();
                ViewBag.TRANSACTION_TYPE_CODE = new SelectList(types, "TRANSACTION_TYPE_CODE", "TRANSACTION_NAME");
            ...
            rA42_TRANSACTION_DTL.ACCESS_ROW_CODE = _SECURITY_PASS_DTL.SECURITY_CODE;
            ...
            db.SaveChanges();
            rA42_SECURITY_PASS_DTL.UPD_BY = currentUser;
            rA42_SECURITY_PASS_DTL.UPD_DT = DateTime.Now;
            rA42_SECURITY_PASS_DTL.ISDELIVERED = false;
            db.SaveChanges();
            ...
            if (CheckPrinted.Equals("Printed"))
            {
                ...
                rA42_SECURITY_PASS_DTL.SECURITY_CODE).ToList();
        ...
        // this view is for searching about employee in the jund api for stay at port for rano
        public ActionResult StayAtPortMod()
        {

            ViewBag.activetab = "StayAtPortMod";
            ...
            if (Language.GetCurrentLang() == "en")
            {
                ...
                var doc = (from a in db.RA42_DOCUMENTS_ACCESS_MST
                           ...
                           where a.ACCESS_TYPE_CODE == ACCESS_TYPE_CODE && a.DLT_STS != true && c.DLT_STS != true && d.FORCE_ID == FORCE_ID && z.CARD_FOR_CODE == 7 && d.DLT_STS != true && z.DLT_STS != true
                           select new
                           {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult StayAtPortMod(RA42_SECURITY_PASS_DTL rA42_SECURITY_PASS_DTL,
            int[] ZONE, int[] SUB_ZONE, int[] FILE_TYPES, string[] FILE_TYPES_TEXT, HttpPostedFileBase[] files, HttpPostedFileBase PERSONAL_IMAGE)
        {
            ...
            {
                //get genders in english 
                ViewBag.GENDER_ID = new SelectList(db.RA42_GENDERS_MST.Where(a => a.DLT_STS != true), "GENDER_ID", "GENDER_E", rA42_SECURITY_PASS_DTL.GENDER_ID);
                //get identities in english 
                ViewBag.IDENTITY_CODE = new SelectList(db.RA42_IDENTITY_MST.Where(a => a.DLT_STS != true), "IDENTITY_CODE", "IDENTITY_TYPE_E", rA42_SECURITY_PASS_DTL.IDENTITY_CODE);
                //get permits types in englsih (مؤقت - ثابت)
                ViewBag.PASS_TYPE_CODE = new SelectList(db.RA42_PASS_TYPE_MST.Where(a => a.DLT_STS != true), "PASS_TYPE_CODE", "PASS_TYPE_E", rA42_SECURITY_PASS_DTL.PASS_TYPE_CODE);
                if (STATION_CODE == 26)
                {
                    ViewBag.PASS_TYPE_CODE = new SelectList(db.RA42_PASS_TYPE_MST.Where(a => a.DLT_STS != true && a.PASS_TYPE_CODE == 1), "PASS_TYPE_CODE", "PASS_TYPE_E");
                ...
                var WORKFLOW_RESPO = db.RA42_ACCESS_SELECT_MST.Where(a => a.RA42_WORKFLOW_RESPONSIBLE_MST.WORKFLOWID == 2 && a.DLT_STS != true && a.RA42_WORKFLOW_RESPONSIBLE_MST.ACTIVE != false && a.RA42_WORKFLOW_RESPONSIBLE_MST.DLT_STS != true && a.ACCESS_TYPE_CODE == ACCESS_TYPE_CODE && a.RA42_WORKFLOW_RESPONSIBLE_MST.STATION_CODE == STATION_CODE).Select(s => new { WORKFLOW_RESPO_CODE = s.RA42_WORKFLOW_RESPONSIBLE_MST.WORKFLOW_RESPO_CODE, RESPONSEPLE_NAME = s.RA42_WORKFLOW_RESPONSIBLE_MST.RESPONSEPLE_NAME_E + " - " + s.RA42_WORKFLOW_RESPONSIBLE_MST.UNIT_NAME_E }).ToList();
                ViewBag.WORKFLOW_RESPO_CODE = new SelectList(WORKFLOW_RESPO, "WORKFLOW_RESPO_CODE", "RESPONSEPLE_NAME", rA42_SECURITY_PASS_DTL.WORKFLOW_RESPO_CODE);
                //get zones and gates in english 
                ViewBag.ZONE_CODE = new SelectList(db.RA42_ZONE_AREA_MST.Where(a => a.STATION_CODE == STATION_CODE && a.DLT_STS == true && a.ZONE_CODE == 129).Select(s => new { ZONE_CODE = s.ZONE_CODE, ZONE_NAME = s.ZONE_NAME_E + (s.REMARKS != null ? " ( " + s.REMARKS + " )" : "") }), "ZONE_CODE", "ZONE_NAME");
                //get documents types for this kind of permit in english 
                var doc = (from a in db.RA42_DOCUMENTS_ACCESS_MST
            ...
            {
                //get genders in arabic 
                ViewBag.GENDER_ID = new SelectList(db.RA42_GENDERS_MST.Where(a => a.DLT_STS != true), "GENDER_ID", "GENDER_A", rA42_SECURITY_PASS_DTL.GENDER_ID);
                //get identities in arabic 
                ViewBag.IDENTITY_CODE = new SelectList(db.RA42_IDENTITY_MST.Where(a => a.DLT_STS != true), "IDENTITY_CODE", "IDENTITY_TYPE_A", rA42_SECURITY_PASS_DTL.IDENTITY_CODE);
                //get permits types in arabic (ثابت - مؤقت)
                ViewBag.PASS_TYPE_CODE = new SelectList(db.RA42_PASS_TYPE_MST.Where(a => a.DLT_STS != true), "PASS_TYPE_CODE", "PASS_TYPE", rA42_SECURITY_PASS_DTL.PASS_TYPE_CODE);
                if (STATION_CODE == 26)
                {
                    ViewBag.PASS_TYPE_CODE = new SelectList(db.RA42_PASS_TYPE_MST.Where(a => a.DLT_STS != true && a.PASS_TYPE_CODE == 1), "PASS_TYPE_CODE", "PASS_TYPE");
            ...
            var num_permits = db.RA42_SECURITY_PASS_DTL.Where(a => a.DLT_STS != true && a.DATE_TO > rA42_SECURITY_PASS_DTL.DATE_TO &&
            a.SERVICE_NUMBER == rA42_SECURITY_PASS_DTL.SERVICE_NUMBER.ToUpper() && a.ISPRINTED == true).ToList();
            ...
            if (ModelState.IsValid)
            {
                    ...
                    try
                    {
                        ...
                        if (PERSONAL_IMAGE != null && PERSONAL_IMAGE.ContentLength > 0)
                        {
                            ...
                            if (general.CheckPersonalImage(PERSONAL_IMAGE.FileName))
                            {
                                ...
                                rA42_SECURITY_PASS_DTL.PERSONAL_IMAGE = fileName;
                ...
                Task<User> callTask = Task.Run(
                    () => (new UserInfo()).getUserInfoFromAPI(rA42_SECURITY_PASS_DTL.SERVICE_NUMBER.ToUpper())
                    );
                callTask.Wait();
                user = callTask.Result;
                rA42_SECURITY_PASS_DTL.SERVICE_NUMBER = rA42_SECURITY_PASS_DTL.SERVICE_NUMBER.ToUpper();
                rA42_SECURITY_PASS_DTL.RESPONSIBLE = currentUser;
                rA42_SECURITY_PASS_DTL.RANK_A = user.NAME_RANK_A;
                rA42_SECURITY_PASS_DTL.RANK_E = user.NAME_RANK_E;
                rA42_SECURITY_PASS_DTL.NAME_A = user.NAME_EMP_A;
                rA42_SECURITY_PASS_DTL.NAME_E = user.NAME_EMP_E;
                if (!string.IsNullOrEmpty(rA42_SECURITY_PASS_DTL.UNIT_A))
                {
                    rA42_SECURITY_PASS_DTL.UNIT_A = rA42_SECURITY_PASS_DTL.UNIT_A;

                }
                else
                {
                    rA42_SECURITY_PASS_DTL.UNIT_A = user.NAME_UNIT_A;
                }
                rA42_SECURITY_PASS_DTL.UNIT_E = user.NAME_UNIT_E;
                rA42_SECURITY_PASS_DTL.PROFESSION_A = user.NAME_TRADE_A;
                rA42_SECURITY_PASS_DTL.PROFESSION_E = user.NAME_TRADE_E;
                rA42_SECURITY_PASS_DTL.PASS_TYPE_CODE = 1;
                ...
                {
                    //the user should redirect the request to the security offcier
                    ...
                    {
                        rA42_SECURITY_PASS_DTL.WORKFLOW_RESPO_CODE = v.WORKFLOW_RESPO_CODE.Value;
                    }

                    rA42_SECURITY_PASS_DTL.APPROVAL_SN = currentUser;
                    rA42_SECURITY_PASS_DTL.APPROVAL_RANK = permit.NAME_RANK_A;
                    rA42_SECURITY_PASS_DTL.APPROVAL_NAME = permit.NAME_EMP_A;
                    rA42_SECURITY_PASS_DTL.PERMIT_APPROVISION_DATE = DateTime.Now;
                    rA42_SECURITY_PASS_DTL.REJECTED = false;
                    rA42_SECURITY_PASS_DTL.STATUS = false;
                    rA42_SECURITY_PASS_DTL.ISOPENED = true;
                }
                ...
                if (WORKFLOWID == 3 && ViewBag.NOT_RELATED_STATION != true)
                {
                    ...
                    rA42_SECURITY_PASS_DTL.PERMIT_SN = currentUser;
                    rA42_SECURITY_PASS_DTL.PERMIT_RANK = permit.NAME_RANK_A;
                    rA42_SECURITY_PASS_DTL.PERMIT_NAME = permit.NAME_EMP_A;
                    rA42_SECURITY_PASS_DTL.PERMIT_APPROVISION_DATE = DateTime.Now;
                    rA42_SECURITY_PASS_DTL.REJECTED = false;
                    rA42_SECURITY_PASS_DTL.STATUS = false;
                    rA42_SECURITY_PASS_DTL.ISOPENED = true;
                ...
                if (WORKFLOWID == 4 && ViewBag.NOT_RELATED_STATION != true)
                {
                    ...
                    rA42_SECURITY_PASS_DTL.AUTHO_SN = currentUser;
                    rA42_SECURITY_PASS_DTL.AUTHO_RANK = permit.NAME_RANK_A;
                    rA42_SECURITY_PASS_DTL.AUTHO_NAME = permit.NAME_EMP_A;
                    rA42_SECURITY_PASS_DTL.AUTHO_APPROVISION_DATE = DateTime.Now;
                    rA42_SECURITY_PASS_DTL.REJECTED = false;
                    rA42_SECURITY_PASS_DTL.STATUS = true;
                    rA42_SECURITY_PASS_DTL.ISOPENED = true;
                }
                rA42_SECURITY_PASS_DTL.CARD_FOR_CODE = 7;
                rA42_SECURITY_PASS_DTL.STATION_CODE = STATION_CODE;
                rA42_SECURITY_PASS_DTL.CRD_BY = currentUser;
                rA42_SECURITY_PASS_DTL.CRD_DT = DateTime.Now;
                rA42_SECURITY_PASS_DTL.UPD_BY = currentUser;
                rA42_SECURITY_PASS_DTL.UPD_DT = DateTime.Now;
                rA42_SECURITY_PASS_DTL.ACCESS_TYPE_CODE = ACCESS_TYPE_CODE;
                rA42_SECURITY_PASS_DTL.BARCODE = rA42_SECURITY_PASS_DTL.BARCODE;
                db.RA42_SECURITY_PASS_DTL.Add(rA42_SECURITY_PASS_DTL);
                db.SaveChanges();
                ...
                if (ZONE != null && !ZONE.Contains(0))
                {
                    for (int i = 0; i < ZONE.Length; i++)
                    {
                        ...
                        rA42_ZONE_MASTER_MST.ACCESS_ROW_CODE = rA42_SECURITY_PASS_DTL.SECURITY_CODE;
                            ...
                            if (file != null && file.ContentLength > 0)
                            {
                                ...
                                if (general.CheckFileType(file.FileName))
                                {
                                    ...
                                    RA42_FILES_MST fILES_MST = new RA42_FILES_MST()
                                    {
                                        ...
                                        ACCESS_ROW_CODE = rA42_SECURITY_PASS_DTL.SECURITY_CODE,
                                ...
                                else
                                {
                                    ...
                                    var delete = db.RA42_FILES_MST.Where(a => a.ACCESS_ROW_CODE == rA42_SECURITY_PASS_DTL.SECURITY_CODE && a.ACCESS_TYPE_CODE == ACCESS_TYPE_CODE).ToList();
        ...
        //stay at port from outside MOD
        public ActionResult StayAtPortForOthers()
        {

            ViewBag.activetab = "StayAtPortForOthers";
            ViewBag.Service_No = currentUser;
            var url = Url.RequestContext.RouteData.Values["id"];
            //int unit = 0;
            //check if the session not null 
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult StayAtPortForOthers(RA42_SECURITY_PASS_DTL rA42_SECURITY_PASS_DTL,
            int[] ZONE, int[] SUB_ZONE, int[] FILE_TYPES, string[] FILE_TYPES_TEXT, HttpPostedFileBase[] files, HttpPostedFileBase PERSONAL_IMAGE)
        {
            ViewBag.activetab = "StayAtPortForOthers";
            var url = Url.RequestContext.RouteData.Values["id"];
            ...
            if (ModelState.IsValid)
            {
                    ...
                    if (PERSONAL_IMAGE != null)
                {
                    ...
                    rA42_SECURITY_PASS_DTL.SERVICE_NUMBER = rA42_SECURITY_PASS_DTL.RESPONSIBLE;
                    rA42_SECURITY_PASS_DTL.RESPONSIBLE = currentUser;
                    rA42_SECURITY_PASS_DTL.CARD_FOR_CODE = 7;
                    rA42_SECURITY_PASS_DTL.RANK_A = rA42_SECURITY_PASS_DTL.RANK_A;
                    rA42_SECURITY_PASS_DTL.RANK_E = rA42_SECURITY_PASS_DTL.RANK_E;
                    rA42_SECURITY_PASS_DTL.NAME_A = rA42_SECURITY_PASS_DTL.NAME_A;
                    rA42_SECURITY_PASS_DTL.NAME_E = rA42_SECURITY_PASS_DTL.NAME_E;
                    rA42_SECURITY_PASS_DTL.UNIT_A = rA42_SECURITY_PASS_DTL.UNIT_A;
                    rA42_SECURITY_PASS_DTL.UNIT_E = rA42_SECURITY_PASS_DTL.UNIT_E;
                    rA42_SECURITY_PASS_DTL.PROFESSION_A = rA42_SECURITY_PASS_DTL.PROFESSION_A;
                    rA42_SECURITY_PASS_DTL.PROFESSION_E = rA42_SECURITY_PASS_DTL.PROFESSION_E;
                    rA42_SECURITY_PASS_DTL.PASS_TYPE_CODE = 1;
                    ...
                    if (WORKFLOWID <= 1 || WORKFLOWID == 2)
                    {
                        ...
                        rA42_SECURITY_PASS_DTL.APPROVAL_SN = currentUser;
                        rA42_SECURITY_PASS_DTL.APPROVAL_RANK = user.NAME_RANK_A;
                        rA42_SECURITY_PASS_DTL.APPROVAL_NAME = user.NAME_EMP_A;
                        rA42_SECURITY_PASS_DTL.PERMIT_APPROVISION_DATE = DateTime.Now;
                        rA42_SECURITY_PASS_DTL.REJECTED = false;
                        rA42_SECURITY_PASS_DTL.STATUS = false;
                        rA42_SECURITY_PASS_DTL.ISOPENED = true;
                    ...
                    if (WORKFLOWID == 3 && ViewBag.NOT_RELATED_STATION != true)
                    {
                        //permits cell should redirect the request to the security officer to complete and the permit 
                        var v = db.RA42_ACCESS_SELECT_MST.Where(a => a.RA42_WORKFLOW_RESPONSIBLE_MST.WORKFLOWID == 4 && a.RA42_WORKFLOW_RESPONSIBLE_MST.STATION_CODE == STATION_CODE && a.RA42_WORKFLOW_RESPONSIBLE_MST.ACTIVE != false && a.DLT_STS != true && a.ACCESS_TYPE_CODE == ACCESS_TYPE_CODE && a.RA42_WORKFLOW_RESPONSIBLE_MST.DLT_STS != true).FirstOrDefault();
                        ...
                        rA42_SECURITY_PASS_DTL.PERMIT_SN = currentUser;
                        //rA42_SECURITY_PASS_DTL.PERMIT_RANK = user.NAME_RANK_A;
                        //rA42_SECURITY_PASS_DTL.PERMIT_NAME = user.NAME_EMP_A;
                        rA42_SECURITY_PASS_DTL.PERMIT_APPROVISION_DATE = DateTime.Now;
                        rA42_SECURITY_PASS_DTL.REJECTED = false;
                        rA42_SECURITY_PASS_DTL.STATUS = false;
                        rA42_SECURITY_PASS_DTL.ISOPENED = true;
                    ...
                    if (WORKFLOWID == 4 && ViewBag.NOT_RELATED_STATION != true)
                    {
                        ...
                        rA42_SECURITY_PASS_DTL.AUTHO_SN = currentUser;
                        rA42_SECURITY_PASS_DTL.AUTHO_RANK = user.NAME_RANK_A;
                        rA42_SECURITY_PASS_DTL.AUTHO_NAME = user.NAME_EMP_A;
                        rA42_SECURITY_PASS_DTL.AUTHO_APPROVISION_DATE = DateTime.Now;
                        rA42_SECURITY_PASS_DTL.REJECTED = false;
                        rA42_SECURITY_PASS_DTL.STATUS = true;
                        rA42_SECURITY_PASS_DTL.ISOPENED = true;
                ...
                {
                    TempData["Erorr"] = eex.GetBaseException();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Search(RA42_SECURITY_PASS_DTL rA42_SECURITY_PASS_DTL,
            int[] ZONE, int[] SUB_ZONE, int[] FILE_TYPES,string[] FILE_TYPES_TEXT, HttpPostedFileBase[] files, HttpPostedFileBase PERSONAL_IMAGE)
        {
            ViewBag.activetab = "Search";
            ViewBag.Service_No = currentUser;
            ...
            //check if employee has more than 2 permits still valid
            var num_permits = db.RA42_SECURITY_PASS_DTL.Where(a => a.DLT_STS != true && a.DATE_TO > DateTime.Today && a.STATION_CODE == STATION_CODE &&
            a.SERVICE_NUMBER == rA42_SECURITY_PASS_DTL.SERVICE_NUMBER.ToUpper() && (a.ISPRINTED == true || a.STATUS != true || a.REJECTED == true) && a.RETURNED != true && a.CARD_FOR_CODE == 1).ToList();
            ...
            if (ModelState.IsValid)
            {
                ...
                if (WORKFLOWID <= 1 || (WORKFLOWID >= 5 && WORKFLOWID <= 11) || ViewBag.NOT_RELATED_STATION == true)
                {
                   //the request will redirected to the autho person as normal request 
                    rA42_SECURITY_PASS_DTL.WORKFLOW_RESPO_CODE = rA42_SECURITY_PASS_DTL.WORKFLOW_RESPO_CODE;
                    rA42_SECURITY_PASS_DTL.REJECTED = false;
                    rA42_SECURITY_PASS_DTL.STATUS = false;
                    rA42_SECURITY_PASS_DTL.ISOPENED = false;
                }
                ...
                if (WORKFLOWID == 2 && ViewBag.NOT_RELATED_STATION != true)
                {
                    ...
                    rA42_SECURITY_PASS_DTL.APPROVAL_RANK = permit.NAME_RANK_A;
                    rA42_SECURITY_PASS_DTL.APPROVAL_NAME = permit.NAME_EMP_A;
                    rA42_SECURITY_PASS_DTL.APPROVAL_APPROVISION_DATE = DateTime.Now;
                    rA42_SECURITY_PASS_DTL.REJECTED = false;
                    rA42_SECURITY_PASS_DTL.STATUS = false;
                    rA42_SECURITY_PASS_DTL.ISOPENED = true;
                }
                ...
                rA42_SECURITY_PASS_DTL.CARD_FOR_CODE = 1;
                rA42_SECURITY_PASS_DTL.STATION_CODE = STATION_CODE;
                rA42_SECURITY_PASS_DTL.CRD_BY = currentUser;
                rA42_SECURITY_PASS_DTL.CRD_DT = DateTime.Now;
                rA42_SECURITY_PASS_DTL.UPD_BY = currentUser;
        ...
        // POST: Securitypass/Create
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create(RA42_SECURITY_PASS_DTL rA42_SECURITY_PASS_DTL,
            int[] ZONE, int[] SUB_ZONE, int[] FILE_TYPES, string[] FILE_TYPES_TEXT, HttpPostedFileBase[] files, HttpPostedFileBase PERSONAL_IMAGE)
        {
            ...
            if (rA42_SECURITY_PASS_DTL.WORKFLOW_RESPO_CODE == null)
            {
                TempData["Erorr"] = Resources.Passes.ResourceManager.GetString("Not_set_respond" + "_" + ViewBag.lang);
                return View(rA42_SECURITY_PASS_DTL);
            ...
            if (ModelState.IsValid)
            {
                ...
                user = callTask.Result;
                rA42_SECURITY_PASS_DTL.CARD_FOR_CODE = 1;
                rA42_SECURITY_PASS_DTL.SERVICE_NUMBER = rA42_SECURITY_PASS_DTL.SERVICE_NUMBER;
                rA42_SECURITY_PASS_DTL.RANK_A = user.NAME_RANK_A;
                rA42_SECURITY_PASS_DTL.RANK_E = user.NAME_RANK_E;
                rA42_SECURITY_PASS_DTL.NAME_A = user.NAME_EMP_A;
                rA42_SECURITY_PASS_DTL.NAME_E = user.NAME_EMP_E;
        ...
        // this view is for authorized user such as permits cell, applicants and security officers etc...
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Supercreate(RA42_SECURITY_PASS_DTL rA42_SECURITY_PASS_DTL,
            int[] ZONE, int[] SUB_ZONE, int[] FILE_TYPES,string[] FILE_TYPES_TEXT, HttpPostedFileBase[] files, HttpPostedFileBase PERSONAL_IMAGE)
        {
            ViewBag.activetab = "Supercreate";
            ViewBag.Service_No = currentUser;
            ...
            if (ModelState.IsValid)
            {
               ...
               //check if user upload  image 
                if (PERSONAL_IMAGE != null)
                {
                    try
                    {
                        ...
                        if (PERSONAL_IMAGE != null && PERSONAL_IMAGE.ContentLength > 0)
                        {
                            ...
                            {
                                //if extention not supported, show error message 
                                AddToast(new Toast("",
                                GetResourcesValue("error_update_message"),
                                "red"));
                                TempData["Erorr"] = "Personal image should be in image format - يجب أن تكون الصورة الشخصية ملف (JPG,GIF)";
                ...
                rA42_SECURITY_PASS_DTL.SERVICE_NUMBER = rA42_SECURITY_PASS_DTL.SERVICE_NUMBER.ToUpper();
                rA42_SECURITY_PASS_DTL.RESPONSIBLE = currentUser;
                rA42_SECURITY_PASS_DTL.CARD_FOR_CODE = 3;
                rA42_SECURITY_PASS_DTL.RANK_A = rA42_SECURITY_PASS_DTL.RANK_A;
                rA42_SECURITY_PASS_DTL.RANK_E = rA42_SECURITY_PASS_DTL.RANK_E;
                rA42_SECURITY_PASS_DTL.NAME_A = rA42_SECURITY_PASS_DTL.NAME_A;
                rA42_SECURITY_PASS_DTL.NAME_E = rA42_SECURITY_PASS_DTL.NAME_E;
                ...
                //this scetion is for permits cell 
                if (WORKFLOWID == 3)
                {
                    //the permits cell should redirect the request to the security officer after create the permit 
                    var v = db.RA42_ACCESS_SELECT_MST.Where(a => a.RA42_WORKFLOW_RESPONSIBLE_MST.WORKFLOWID == 4 && a.RA42_WORKFLOW_RESPONSIBLE_MST.STATION_CODE == STATION_CODE && a.RA42_WORKFLOW_RESPONSIBLE_MST.ACTIVE != false && a.DLT_STS != true && a.ACCESS_TYPE_CODE == ACCESS_TYPE_CODE && a.RA42_WORKFLOW_RESPONSIBLE_MST.DLT_STS != true).FirstOrDefault();
                    ...
                    try
                    {
                        ...
                        foreach (HttpPostedFileBase file in files)
                        {
                            ...
                            if (file != null && file.ContentLength > 0)
                            {
                                ...
                                {
                                    //delete whole files if there is somthing wrong with one document, this is security procedures 
                                    var delete = db.RA42_FILES_MST.Where(a => a.ACCESS_ROW_CODE == rA42_SECURITY_PASS_DTL.SECURITY_CODE && a.ACCESS_TYPE_CODE == ACCESS_TYPE_CODE).ToList();
                                    foreach (var del in delete)
                                    {
                                        string filpath = "~/Documents/" + del.FILE_NAME;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Otherpermit(RA42_SECURITY_PASS_DTL rA42_SECURITY_PASS_DTL,
            int[] ZONE, int[] SUB_ZONE, int[] FILE_TYPES,string[] FILE_TYPES_TEXT, HttpPostedFileBase[] files, HttpPostedFileBase PERSONAL_IMAGE)
        {
            ViewBag.activetab = "Otherpermit";
            var url = Url.RequestContext.RouteData.Values["id"];
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Companypermit(RA42_SECURITY_PASS_DTL rA42_SECURITY_PASS_DTL,
            int[] ZONE, int[] SUB_ZONE, int[] FILE_TYPES,string[] FILE_TYPES_TEXT, HttpPostedFileBase[] files, HttpPostedFileBase PERSONAL_IMAGE)
        {
            ViewBag.activetab = "Companypermit";
            var url = Url.RequestContext.RouteData.Values["id"];
            ...
            { 
                //companies
                ViewBag.COMPANY_CODE = new SelectList(db.RA42_COMPANY_MST.Where(a => a.DLT_STS != true && a.COMPANY_TYPE_CODE == COMPANY_TYPE_CODE && a.STATION_CODE == rA42_SECURITY_PASS_DTL.COMPANY_CODE), "COMPANY_CODE", "COMPANY_NAME_E");
                //get genders in english 
                ViewBag.GENDER_ID = new SelectList(db.RA42_GENDERS_MST.Where(a => a.DLT_STS != true), "GENDER_ID", "GENDER_E", rA42_SECURITY_PASS_DTL.GENDER_ID);
                //get identities in english 
                ViewBag.IDENTITY_CODE = new SelectList(db.RA42_IDENTITY_MST.Where(a => a.DLT_STS != true), "IDENTITY_CODE", "IDENTITY_TYPE_E", rA42_SECURITY_PASS_DTL.IDENTITY_CODE);
            ...
            {
                //companies
                ViewBag.COMPANY_CODE = new SelectList(db.RA42_COMPANY_MST.Where(a => a.DLT_STS != true && a.COMPANY_TYPE_CODE == COMPANY_TYPE_CODE && a.STATION_CODE == rA42_SECURITY_PASS_DTL.COMPANY_CODE), "COMPANY_CODE", "COMPANY_NAME");
                //get genders in arabic 
                ViewBag.GENDER_ID = new SelectList(db.RA42_GENDERS_MST.Where(a => a.DLT_STS != true), "GENDER_ID", "GENDER_A", rA42_SECURITY_PASS_DTL.GENDER_ID);
                //get identities in arabic 
                ViewBag.IDENTITY_CODE = new SelectList(db.RA42_IDENTITY_MST.Where(a => a.DLT_STS != true), "IDENTITY_CODE", "IDENTITY_TYPE_A", rA42_SECURITY_PASS_DTL.IDENTITY_CODE);
            ...
            if (ModelState.IsValid)
            {
                ...
                rA42_SECURITY_PASS_DTL.SERVICE_NUMBER = rA42_SECURITY_PASS_DTL.RESPONSIBLE;
                rA42_SECURITY_PASS_DTL.RESPONSIBLE = currentUser;
                rA42_SECURITY_PASS_DTL.CARD_FOR_CODE = 2;
                rA42_SECURITY_PASS_DTL.RANK_A = rA42_SECURITY_PASS_DTL.RANK_A;
                rA42_SECURITY_PASS_DTL.RANK_E = rA42_SECURITY_PASS_DTL.RANK_E;
                rA42_SECURITY_PASS_DTL.NAME_A = rA42_SECURITY_PASS_DTL.NAME_A;
                rA42_SECURITY_PASS_DTL.NAME_E = rA42_SECURITY_PASS_DTL.NAME_E;
        ...
        public ActionResult Edit(int? id)
        {
            ...
            if (ViewBag.RESPO_STATE <= 1)
            {
                ...
                if (rA42_SECURITY_PASS_DTL.ISOPENED == true)
                {
                    if (ViewBag.ADMIN != true && ViewBag.DEVELOPER != true)
                    {
                        if (rA42_SECURITY_PASS_DTL.RA42_WORKFLOW_RESPONSIBLE_MST.WORKFLOWID == 2 && rA42_SECURITY_PASS_DTL.REJECTED == true)
                        {
            ...
            {
                //companies
                ViewBag.COMPANY_CODE = new SelectList(db.RA42_COMPANY_MST.Where(a => a.DLT_STS != true && a.COMPANY_TYPE_CODE == COMPANY_TYPE_CODE && a.STATION_CODE == rA42_SECURITY_PASS_DTL.STATION_CODE), "COMPANY_CODE", "COMPANY_NAME_E",rA42_SECURITY_PASS_DTL.COMPANY_CODE);
                //get genders in english 
                ViewBag.GENDER_ID = new SelectList(db.RA42_GENDERS_MST.Where(a => a.DLT_STS != true), "GENDER_ID", "GENDER_E", rA42_SECURITY_PASS_DTL.GENDER_ID);
                //get identities in english 
                ViewBag.IDENTITY_CODE = new SelectList(db.RA42_IDENTITY_MST.Where(a => a.DLT_STS != true), "IDENTITY_CODE", "IDENTITY_TYPE_E", rA42_SECURITY_PASS_DTL.IDENTITY_CODE);
                ...
                ViewBag.PASS_TYPE_CODE = new SelectList(db.RA42_PASS_TYPE_MST.Where(a => a.DLT_STS != true), "PASS_TYPE_CODE", "PASS_TYPE_E", rA42_SECURITY_PASS_DTL.PASS_TYPE_CODE);
                if (rA42_SECURITY_PASS_DTL.STATION_CODE == 26)
                {
                    ViewBag.PASS_TYPE_CODE = new SelectList(db.RA42_PASS_TYPE_MST.Where(a => a.DLT_STS != true && a.PASS_TYPE_CODE == 1), "PASS_TYPE_CODE", "PASS_TYPE_E");

                }
                //get zones and gates in english 
                ViewBag.ZONE_CODE = new SelectList(db.RA42_ZONE_AREA_MST.Where(a => a.STATION_CODE == rA42_SECURITY_PASS_DTL.STATION_CODE && a.DLT_STS != true).Select(s => new { ZONE_CODE = s.ZONE_CODE, ZONE_NAME = s.ZONE_NAME_E + (s.REMARKS != null ? " ( " + s.REMARKS + " )" : "") }), "ZONE_CODE", "ZONE_NAME");
                //get documents types for this kind of permit in english 
                var doc = (from a in db.RA42_DOCUMENTS_ACCESS_MST
                           join c in db.RA42_FILE_TYPE_MST on a.FILE_TYPE_CODE equals c.FILE_TYPE_CODE
                           join d in db.RA42_FILE_FORCES_MST on c.FILE_TYPE_CODE equals d.FILE_TYPE_CODE
                           join z in db.RA42_FILE_CARD_MST on c.FILE_TYPE_CODE equals z.FILE_TYPE_CODE
                           where a.ACCESS_TYPE_CODE == ACCESS_TYPE_CODE && a.DLT_STS != true && c.DLT_STS != true && d.FORCE_ID == rA42_SECURITY_PASS_DTL.RA42_STATIONS_MST.FORCE_ID && z.CARD_FOR_CODE == rA42_SECURITY_PASS_DTL.CARD_FOR_CODE && d.DLT_STS != true && z.DLT_STS != true
                           select new
                           {
                               FILE_TYPE_CODE = c.FILE_TYPE_CODE,
                               FILE_TYPE = c.FILE_TYPE_E + " - " + c.FILE_NOTE_CODE
               ...
               //get autho person for this kind of permit in english 
                var WORKFLOW_RESPO = db.RA42_ACCESS_SELECT_MST.Where(a => a.RA42_WORKFLOW_RESPONSIBLE_MST.WORKFLOWID == 2 && a.DLT_STS != true && a.RA42_WORKFLOW_RESPONSIBLE_MST.ACTIVE != false && a.RA42_WORKFLOW_RESPONSIBLE_MST.DLT_STS != true && a.ACCESS_TYPE_CODE == ACCESS_TYPE_CODE && a.RA42_WORKFLOW_RESPONSIBLE_MST.STATION_CODE == rA42_SECURITY_PASS_DTL.STATION_CODE).Select(s => new { WORKFLOW_RESPO_CODE = s.RA42_WORKFLOW_RESPONSIBLE_MST.WORKFLOW_RESPO_CODE, RESPONSEPLE_NAME = s.RA42_WORKFLOW_RESPONSIBLE_MST.RANK_E + " - " + s.RA42_WORKFLOW_RESPONSIBLE_MST.RESPONSEPLE_NAME_E + " - " + s.RA42_WORKFLOW_RESPONSIBLE_MST.UNIT_NAME_E }).ToList();
                ViewBag.WORKFLOW_RESPO_CODE = new SelectList(WORKFLOW_RESPO, "WORKFLOW_RESPO_CODE", "RESPONSEPLE_NAME", rA42_SECURITY_PASS_DTL.WORKFLOW_RESPO_CODE);
                ...
                if (ViewBag.DEVELOPER == true)
                {
                    ...
                    ViewBag.WORKFLOW_RESPO_CODE = new SelectList(WORKFLOW_RESPO_1, "WORKFLOW_RESPO_CODE", "RESPONSEPLE_NAME", rA42_SECURITY_PASS_DTL.WORKFLOW_RESPO_CODE);
                }
            }
            else
            {
                //companies
                ViewBag.COMPANY_CODE = new SelectList(db.RA42_COMPANY_MST.Where(a => a.DLT_STS != true && a.COMPANY_TYPE_CODE == COMPANY_TYPE_CODE && a.STATION_CODE == rA42_SECURITY_PASS_DTL.STATION_CODE), "COMPANY_CODE", "COMPANY_NAME",rA42_SECURITY_PASS_DTL.COMPANY_CODE);
                //get genders in arabic 
                ViewBag.GENDER_ID = new SelectList(db.RA42_GENDERS_MST.Where(a => a.DLT_STS != true), "GENDER_ID", "GENDER_A", rA42_SECURITY_PASS_DTL.GENDER_ID);
                //get idnetities in arabic 
                ViewBag.IDENTITY_CODE = new SelectList(db.RA42_IDENTITY_MST.Where(a => a.DLT_STS != true), "IDENTITY_CODE", "IDENTITY_TYPE_A", rA42_SECURITY_PASS_DTL.IDENTITY_CODE);
                ...
                //get zones and gates in ar 
                ViewBag.ZONE_CODE = new SelectList(db.RA42_ZONE_AREA_MST.Where(a => a.STATION_CODE == rA42_SECURITY_PASS_DTL.STATION_CODE && a.DLT_STS != true).Select(s => new { ZONE_CODE = s.ZONE_CODE, ZONE_NAME = s.ZONE_NAME + (s.REMARKS != null ? " ( " + s.REMARKS + " )" : "") }), "ZONE_CODE", "ZONE_NAME");
                //get documents types for this kind of permit in ar 
                var doc = (from a in db.RA42_DOCUMENTS_ACCESS_MST
                           join c in db.RA42_FILE_TYPE_MST on a.FILE_TYPE_CODE equals c.FILE_TYPE_CODE
                           join d in db.RA42_FILE_FORCES_MST on c.FILE_TYPE_CODE equals d.FILE_TYPE_CODE
            ...
            //get selected zones of the permit 
            ViewBag.GetZones = db.RA42_ZONE_MASTER_MST.Where(a => a.ACCESS_ROW_CODE == id && a.DLT_STS != true && a.ACCESS_TYPE_CODE == ACCESS_TYPE_CODE).ToList();
            ...
            ViewBag.COMMENTS = cOMMENTS;
            //get uploaded image 
            ViewBag.PERSONAL_IMAGE = rA42_SECURITY_PASS_DTL.PERSONAL_IMAGE;
            //get status of this permit 
            ViewBag.STATUS = rA42_SECURITY_PASS_DTL.STATUS;
            return View(rA42_SECURITY_PASS_DTL);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(RA42_SECURITY_PASS_DTL rA42_SECURITY_PASS_DTL, string COMMENT,
            FormCollection form,
            ...
            files, HttpPostedFileBase PERSONAL_IMAGE)
        {
            ...
            {
                //companies
                ViewBag.COMPANY_CODE = new SelectList(db.RA42_COMPANY_MST.Where(a => a.DLT_STS != true && a.COMPANY_TYPE_CODE == COMPANY_TYPE_CODE && a.STATION_CODE == general_data.STATION_CODE), "COMPANY_CODE", "COMPANY_NAME_E",rA42_SECURITY_PASS_DTL.COMPANY_CODE);
                //get genders in english 
                ViewBag.GENDER_ID = new SelectList(db.RA42_GENDERS_MST.Where(a => a.DLT_STS != true), "GENDER_ID", "GENDER_E", rA42_SECURITY_PASS_DTL.GENDER_ID);
                //get identities in english 
                ViewBag.IDENTITY_CODE = new SelectList(db.RA42_IDENTITY_MST.Where(a => a.DLT_STS != true), "IDENTITY_CODE", "IDENTITY_TYPE_E", rA42_SECURITY_PASS_DTL.IDENTITY_CODE);
            ...
            {
                //companies
                ViewBag.COMPANY_CODE = new SelectList(db.RA42_COMPANY_MST.Where(a => a.DLT_STS != true && a.COMPANY_TYPE_CODE == COMPANY_TYPE_CODE && a.STATION_CODE == general_data.STATION_CODE), "COMPANY_CODE", "COMPANY_NAME",rA42_SECURITY_PASS_DTL.COMPANY_CODE);
                //get genders in arabic 
                ViewBag.GENDER_ID = new SelectList(db.RA42_GENDERS_MST.Where(a => a.DLT_STS != true), "GENDER_ID", "GENDER_A", rA42_SECURITY_PASS_DTL.GENDER_ID);
                //get identities in arabic 
                ViewBag.IDENTITY_CODE = new SelectList(db.RA42_IDENTITY_MST.Where(a => a.DLT_STS != true), "IDENTITY_CODE", "IDENTITY_TYPE_A", rA42_SECURITY_PASS_DTL.IDENTITY_CODE);
            ...
            if (ModelState.IsValid)
            {
                        ...
                        foreach (HttpPostedFileBase file in files)
                        {
                            ...
                            if (file != null && file.ContentLength > 0)
                            {
                                ...
                                else
                                {
                                    ...
                                    var delete = db.RA42_FILES_MST.Where(a => a.ACCESS_ROW_CODE == rA42_SECURITY_PASS_DTL.SECURITY_CODE).ToList();
                                    foreach (var del in delete)
                                    {
                                        string filpath = "~/Documents/" + del.FILE_NAME;
                                        general.RemoveFileFromServer(filpath);
                                    ...
                                    return RedirectToAction("Edit", new { id = rA42_SECURITY_PASS_DTL.SECURITY_CODE });
                                }
                            }
                ...
                if (rA42_SECURITY_PASS_DTL.PERSONAL_IMAGE != null)
                {
                    general_data.PERSONAL_IMAGE = rA42_SECURITY_PASS_DTL.PERSONAL_IMAGE;
                }
                else
                {
                ...
                if (form["approvebtn"] != null && (WORKFLOWID <= 1 || ((WORKFLOWID >= 5 && WORKFLOWID <= 11))))
                {
                    ...
                    general_data.COMPANY_CODE = rA42_SECURITY_PASS_DTL.COMPANY_CODE;
                    ...
                    {
                        general_data.WORKFLOW_RESPO_CODE = rA42_SECURITY_PASS_DTL.WORKFLOW_RESPO_CODE;
                    }
                    ...
                    general_data.SERVICE_NUMBER = rA42_SECURITY_PASS_DTL.SERVICE_NUMBER;
                    general_data.CIVIL_NUMBER = rA42_SECURITY_PASS_DTL.CIVIL_NUMBER;
                    general_data.RANK_A = rA42_SECURITY_PASS_DTL.RANK_A;
                    general_data.RANK_E = rA42_SECURITY_PASS_DTL.RANK_E;
                    general_data.NAME_A = rA42_SECURITY_PASS_DTL.NAME_A;
                    general_data.NAME_E = rA42_SECURITY_PASS_DTL.NAME_E;
                    general_data.PHONE_NUMBER = rA42_SECURITY_PASS_DTL.PHONE_NUMBER;
                    general_data.GSM = rA42_SECURITY_PASS_DTL.GSM;
                    general_data.IDENTITY_CODE = rA42_SECURITY_PASS_DTL.IDENTITY_CODE;
                    general_data.GENDER_ID = rA42_SECURITY_PASS_DTL.GENDER_ID;
                    general_data.UNIT_A = rA42_SECURITY_PASS_DTL.UNIT_A;
                    general_data.UNIT_E = rA42_SECURITY_PASS_DTL.UNIT_E;
                    general_data.PROFESSION_A = rA42_SECURITY_PASS_DTL.PROFESSION_A;
                    general_data.PROFESSION_E = rA42_SECURITY_PASS_DTL.PROFESSION_E;
                    general_data.PASS_TYPE_CODE = rA42_SECURITY_PASS_DTL.PASS_TYPE_CODE;
                    general_data.DATE_FROM = rA42_SECURITY_PASS_DTL.DATE_FROM;
                    general_data.PURPOSE_OF_PASS = rA42_SECURITY_PASS_DTL.PURPOSE_OF_PASS;
                    general_data.DATE_TO = rA42_SECURITY_PASS_DTL.DATE_TO;
                    general_data.REMARKS = rA42_SECURITY_PASS_DTL.REMARKS;
                ...
                if (form["approvebtn"] != null && x.RA42_WORKFLOW_RESPONSIBLE_MST.WORKFLOWID == 3)
                {
                    ...
                    //check if the status of the permit is complete, then just edit the permit without redirect it to the security officer, otherwise redirect it to security officer
                ...
                if (form["approvebtn"] != null && x.RA42_WORKFLOW_RESPONSIBLE_MST.WORKFLOWID == 4)
                {
                    ...
                    general_data.PERMIT_RANK = general_data.PERMIT_RANK;
                    general_data.PERMIT_APPROVISION_DATE = general_data.PERMIT_APPROVISION_DATE;
                    general_data.BARCODE = rA42_SECURITY_PASS_DTL.BARCODE;
                    general_data.REJECTED = false;
                ...
                //this section is for security officer and return it permits cell
        ...
        public ActionResult Renew(int? id)
        {
            ...
            if (rA42_SECURITY_PASS_DTL.SERVICE_NUMBER == currentUser || rA42_SECURITY_PASS_DTL.RESPONSIBLE == currentUser)
            {
                if (rA42_SECURITY_PASS_DTL.DATE_TO != null)
                {

                    string date = rA42_SECURITY_PASS_DTL.CheckDate(rA42_SECURITY_PASS_DTL.DATE_TO.Value);
            ...
            //check if the user want to request permit in his station
            ViewBag.NOT_RELATED_STATION = false;
            if (rA42_SECURITY_PASS_DTL.STATION_CODE != ViewBag.STATION_CODE_TYPE)
            {
                ViewBag.NOT_RELATED_STATION = true;
            }
            //get documents of this kind of permit to compare between uploaded documenst and missing documenst 
            ...
            rA42_SECURITY_PASS_DTL.DATE_FROM = null;
            rA42_SECURITY_PASS_DTL.DATE_TO = null;
            return View(rA42_SECURITY_PASS_DTL);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Renew(RA42_SECURITY_PASS_DTL rA42_SECURITY_PASS_DTL,
            int[] ZONE, int[] SUB_ZONE, int[] FILE_TYPES,int SECURITY_ID, string[] FILE_TYPES_TEXT, HttpPostedFileBase[]
            files, HttpPostedFileBase PERSONAL_IMAGE)
        {
            ViewBag.activetab = "renew";
            var general_data = db.RA42_SECURITY_PASS_DTL.Where(a => a.SECURITY_CODE == SECURITY_ID).FirstOrDefault();
            //check if the user want to request permit in his station
            ViewBag.NOT_RELATED_STATION = false;
            ...
            ViewBag.GetZones = db.RA42_ZONE_MASTER_MST.Where(a => a.ACCESS_ROW_CODE == SECURITY_ID && a.DLT_STS != true && a.ACCESS_TYPE_CODE == ACCESS_TYPE_CODE).ToList();
            //get selected documents for this permit 
            ViewBag.GetFiles = db.RA42_FILES_MST.Where(a => a.ACCESS_ROW_CODE == SECURITY_ID && a.DLT_STS != true && a.ACCESS_TYPE_CODE == ACCESS_TYPE_CODE).ToList();
            ...
            if (ModelState.IsValid)
            {
                ...
                if (rA42_SECURITY_PASS_DTL.PERSONAL_IMAGE != null)
                {
                    rA42_SECURITY_PASS_DTL.PERSONAL_IMAGE = rA42_SECURITY_PASS_DTL.PERSONAL_IMAGE;
                }
                else
                {
                    rA42_SECURITY_PASS_DTL.PERSONAL_IMAGE = general_data.PERSONAL_IMAGE;

                }
                rA42_SECURITY_PASS_DTL.SERVICE_NUMBER = rA42_SECURITY_PASS_DTL.SERVICE_NUMBER;
                rA42_SECURITY_PASS_DTL.RESPONSIBLE = currentUser;
                rA42_SECURITY_PASS_DTL.CARD_FOR_CODE = general_data.CARD_FOR_CODE;
                rA42_SECURITY_PASS_DTL.RANK_A = rA42_SECURITY_PASS_DTL.RANK_A;
                rA42_SECURITY_PASS_DTL.RANK_E = rA42_SECURITY_PASS_DTL.RANK_E;
                rA42_SECURITY_PASS_DTL.NAME_A = rA42_SECURITY_PASS_DTL.NAME_A;
                rA42_SECURITY_PASS_DTL.NAME_E = rA42_SECURITY_PASS_DTL.NAME_E;
                ...
                rA42_SECURITY_PASS_DTL.STATION_CODE = general_data.STATION_CODE;
                rA42_SECURITY_PASS_DTL.CRD_BY = currentUser;
                rA42_SECURITY_PASS_DTL.CRD_DT = DateTime.Now;
                rA42_SECURITY_PASS_DTL.UPD_BY = currentUser;
                rA42_SECURITY_PASS_DTL.UPD_DT = DateTime.Now;
                ...
                var zones = db.RA42_ZONE_MASTER_MST.Where(a => a.ACCESS_ROW_CODE == SECURITY_ID && a.ACCESS_TYPE_CODE == ACCESS_TYPE_CODE && a.DLT_STS != true).ToList();
                        ...
                        foreach (HttpPostedFileBase file in files)
                        {
                            ...
                            if (file != null && file.ContentLength > 0)
                            {
                                ...
                                else
                                {
                                    ...
                                    TempData["Erorr"] = "Not supported files format - صيغة الملف غير مدعومة";
                                    return RedirectToAction("Renew", new { id = SECURITY_ID });
                                }
                            }
                ...
                var selected_files = db.RA42_FILES_MST.Where(a => a.ACCESS_ROW_CODE == SECURITY_ID && a.ACCESS_TYPE_CODE == ACCESS_TYPE_CODE && a.DLT_STS != true).ToList();
        ...
        public ActionResult Delete(int? id)
        {
            ...
            if (ViewBag.RESPO_STATE <= 1)
            {
                if (rA42_SECURITY_PASS_DTL.SERVICE_NUMBER != currentUser && rA42_SECURITY_PASS_DTL.RESPONSIBLE != currentUser)
                {
                    if (rA42_SECURITY_PASS_DTL.STATUS == true)
                    {
                        if (ViewBag.ADMIN != true && ViewBag.DEVELOPER != true)
                        {
            ...
            //get selected documents and files and zones 
            ViewBag.GetZones = db.RA42_ZONE_MASTER_MST.Where(a => a.ACCESS_ROW_CODE == id && a.DLT_STS != true && a.ACCESS_TYPE_CODE == ACCESS_TYPE_CODE).ToList();
            ViewBag.GetFiles = db.RA42_FILES_MST.Where(a => a.ACCESS_ROW_CODE == id && a.DLT_STS != true && a.ACCESS_TYPE_CODE == ACCESS_TYPE_CODE).ToList();
        ...
        {
            var general_data = db.RA42_SECURITY_PASS_DTL.Where(a => a.SECURITY_CODE == id).FirstOrDefault();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult ProveIdentity(RA42_SECURITY_PASS_DTL rA42_SECURITY_PASS_DTL,
            int[] ZONE, int[] SUB_ZONE, int[] FILE_TYPES, string[] FILE_TYPES_TEXT, HttpPostedFileBase[] files, HttpPostedFileBase PERSONAL_IMAGE)
        {
            ViewBag.activetab = "ProveIdentity";
            var url = Url.RequestContext.RouteData.Values["id"];
            ...
            if (ModelState.IsValid)
            {
                ...
                rA42_SECURITY_PASS_DTL.SERVICE_NUMBER = rA42_SECURITY_PASS_DTL.RESPONSIBLE;
                rA42_SECURITY_PASS_DTL.RESPONSIBLE = currentUser;
                rA42_SECURITY_PASS_DTL.CARD_FOR_CODE = 10;
                rA42_SECURITY_PASS_DTL.RANK_A = rA42_SECURITY_PASS_DTL.RANK_A;
                rA42_SECURITY_PASS_DTL.RANK_E = rA42_SECURITY_PASS_DTL.RANK_E;
                rA42_SECURITY_PASS_DTL.NAME_A = rA42_SECURITY_PASS_DTL.NAME_A;
                rA42_SECURITY_PASS_DTL.NAME_E = rA42_SECURITY_PASS_DTL.NAME_E;
