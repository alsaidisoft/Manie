...
{
    [MetadataType(typeof(RA42_SECURITY_PASS_DTLMetadata))]
    public partial class RA42_SECURITY_PASS_DTL
    {
        ...
        public static implicit operator RA42_SECURITY_PASS_DTL(HttpPostedFileBase v)
        {
            throw new NotImplementedException();
        }

        public int countCommennts(int security_pass_code)
        {
           
            var v = db.RA42_COMMENTS_MST.Where(a => a.PASS_ROW_CODE == security_pass_code && a.ACCESS_TYPE_CODE == ACCESS_TYPE).Count();
            return v;
        }
    ...
    public class RA42_SECURITY_PASS_DTLMetadata
    {
