...
{
    [MetadataType(typeof(RA42_COMPANY_PASS_DTLMetadata))]
    public partial class RA42_COMPANY_PASS_DTL
    {
        RA42_SECURITY_CLEARANCEEntities db = new RA42_SECURITY_CLEARANCEEntities();

        public static implicit operator RA42_COMPANY_PASS_DTL(HttpPostedFileBase v)
        {
        ...
        public int countCommennts(int company_pass_code)
        {
            ...
            var v = db.RA42_COMMENTS_MST.Where(a => a.PASS_ROW_CODE == company_pass_code && a.ACCESS_TYPE_CODE == 5).Count();
            return v;
        }
    ...
    public class RA42_COMPANY_PASS_DTLMetadata
    {
