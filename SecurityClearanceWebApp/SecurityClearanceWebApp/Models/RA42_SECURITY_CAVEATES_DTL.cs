...
namespace SecurityClearanceWebApp.Models
{
    ...
    public partial class RA42_SECURITY_CAVEATES_DTL
    {
        public int SECURITY_CAVEATES_CODE { get; set; }
        public string SECURITY_CAVEATES_AR { get; set; }
        public string SECURITY_CAVEATES_EN { get; set; }
